...
num=122;  %%AS3=103 AS2=122  AS1=120
% m = size(F_train,1);
% n = size(F_train,2);
...
[a, b] = RBD(single(F_train),1e-20);   %% Make sure you save the variable name RBD at the end of RBD function
...
F_train2 = a'*F_train;
F_test2  = a'*F_test;
% F_train2 = F_train2./(repmat(sqrt(sum(F_train2.*F_train2)), [Dim,1]));
% F_test2  = F_test2./(repmat(sqrt(sum(F_test2.*F_test2)), [Dim,1]));

% F_train2(find(isnan(F_train2)))=0;
% F_test2(find(isnan(F_test2)))=0;
...
params.class_num  =  30; %% 14 for gamma=0, %% AS1 = 20, AS2 = 30, AS3 = 20 
...
fprintf('Accuracy = %f\n', accuracy);
fileID2 = fopen('../results/FinalResults_AS2_bicubic.txt','w');
fprintf(fileID2,'Actionset2 Bicubic Pro-CRC Results %f\n L2-CRC Results %f \n',(accuracy), (accuracy1))
fclose(fileID2)
