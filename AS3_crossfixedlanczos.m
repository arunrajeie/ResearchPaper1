...
params.gamma     =  0.1;      %% Set params.class_num = 14,15 in case of 0
% params.gamma     =  0.1; %% Try 1e-2, 0.1-AS3, 0.01-AS2, 0.01-AS1
% params.lambda     =  [1e-1];
% params.lambda     =  0;   %% good accuracy
params.lambda     = 0.01;   %% Try 1e-1, 0.01-AS3, 0.1-AS2, 0.1-AS1
...
fprintf('Accuracy = %f\n', accuracy);
fileID33 = fopen('../results/FinalResults_AS3_lanczos.txt','w');
fprintf(fileID33,'Actionset3 Lanczos Pro-CRC Results %f\n L2-CRC Results %f \n',(accuracy*100), (accuracy1*100))
