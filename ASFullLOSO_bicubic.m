...
fid = fopen('../results/ASfullLOSO_bicubicresults.txt','w') ;   %% For storing the results
...
fprintf(fid,['\nThe accuracy on the ', params.dataset_name, ' dataset ',' with gamma=',num2str(params.gamma), ' and lambda=',num2str(params.lambda), ' is ', num2str(roundn(accuracy11(row1),-3)),'\n'])
fprintf(fid,'\n') ;
clear data;
...
fprintf(fid,['\nThe accuracy on the ', params.dataset_name, ' dataset ',' with gamma=',num2str(params.gamma), ' and lambda=',num2str(params.lambda), ' is ', num2str(roundn(accuracy22(row1),-3)),'\n'])
fprintf(fid,'\n') ;
clear data;
...
fprintf(fid,['\nThe accuracy on the ', params.dataset_name, ' dataset ',' with gamma=',num2str(params.gamma), ' and lambda=',num2str(params.lambda), ' is ', num2str(roundn(accuracy33(row1),-3)),'\n'])
fprintf(fid,'\n') ;
clear data;
...
fprintf(fid,['\nThe accuracy on the ', params.dataset_name, ' dataset ',' with gamma=',num2str(params.gamma), ' and lambda=',num2str(params.lambda), ' is ', num2str(roundn(accuracy44(row1),-3)),'\n'])
fprintf(fid,'\n') ;
...
fprintf(fid,'Average accuracy of LOSO Bicubic L2CRC with RBD(Identity Norm) = %f; and Standard Deviation = %f \n', mean(accuracy1), std(accuracy1));
fprintf(fid,'Average accuracy of LOSO Bicubic L2CRC with RBD(Allones Norm - Proposed) = %f; and Standard Deviation = %f \n', mean(accuracy2), std(accuracy2));
fprintf(fid,'Average accuracy of LOSO Bicubic L2CRC with RBD(Digonal Norm) = %f; and Standard Deviation = %f \n', mean(accuracy3), std(accuracy3));
fprintf(fid,'Average accuracy of LOSO Bicubic L2CRC with RBD(SPD Norm) = %f; and Standard Deviation = %f \n', mean(accuracy4), std(accuracy4));

fprintf(fid,'Average accuracy of LOSO Bicubic Pro-CRC with RBD(Identity Norm) = %f; and Standard Deviation = %f \n', mean(accuracy11), std(accuracy11));
fprintf(fid,'Average accuracy of LOSO Bicubic Pro-CRC with RBD(Allones Norm - Proposed) = %f; and Standard Deviation = %f \n', mean(accuracy22), std(accuracy22));
fprintf(fid,'Average accuracy of LOSO Bicubic Pro-CRC with RBD(Digonal Norm) = %f; and Standard Deviation = %f \n', mean(accuracy33), std(accuracy33));
fprintf(fid,'Average accuracy of LOSO Bicubic Pro-CRC with RBD(SPD Norm) = %f; and Standard Deviation = %f \n', mean(accuracy44), std(accuracy44));
