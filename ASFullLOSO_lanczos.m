...
fid = fopen('../results/ASfullLOSO_lanczosresults.txt','w') ;   %% For storing the results
...
fprintf(fid,['\nThe accuracy of Pro-CRC on ', params.dataset_name, ' dataset ',' with gamma=',num2str(params.gamma), ' and lambda=',num2str(params.lambda), ' is ', num2str(roundn(accuracy44(row1),-3)),'\n'])
fprintf(fid,'\n') ;
